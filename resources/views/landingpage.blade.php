...
<head>
    ...
    <body>
    <nav style="position: absolute;" role="navigation">
    ...
    <div class="container valign-wrapper" style="height: 100vh">
        <div class="row">
            <div class="col s5 m4 l4">
                <img class="responsive-img" src="https://www.clipartmax.com/png/full/248-2484462_pin-health-care-pictures-clip-art-health-gif.png" alt="Ilustrasi">
            </div>
            <div class="col s12 m8 l8 container" style="padding-top: 60px;">
                <h4>Rumah sakit jadi lebih terjangkau dengan antrean yang pendek</h4>
                <br>
                <a class="waves-effect waves-light btn">Mulai Sekarang</a>
            </div>
        </div>
    </div>
